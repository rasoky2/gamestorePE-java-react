  ...
  return (
    <div className="bg-[#171a21]">
      <div className="flex items-center  max-w-[70vw] mx-auto relative">
        {/* Left */}
        <div className="flex items-center justify-center w-full px-2 py-2 lg:justify-start lg:py-6 lg:px-8 lg:w-auto ">
          <div className="absolute text-white lg:hidden left-4">
